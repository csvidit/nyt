...
export default function NewsItem(props: { url: string | UrlObject; title: string; abstract: string; time: string }) {
  ...
  return (
    <motion.div className="flex flex-col space-y-1 justify-center items-center" variants={mainVariants} whileInView="focus" initial="initial">
      <Link
        href={props.url}
